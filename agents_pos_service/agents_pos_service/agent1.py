    ...
    def plot_board(self, drones_pos, step):
        ...
        if self.mu and self.clusters:
            ...
            for m, clu in clus.items():
                ...
                plt.plot(drones_pos[0][0], drones_pos[0][1], marker='<', \
    ...
    def find_centers(self, drones, step=0, method='random'):
        ...
        if not self._has_converged():
            ...
            for t in range (0, 6):
                ...
                drones[MY_ID][0] = drones[MY_ID][0]+(self.mu[MY_ID][0] - drones[MY_ID][0])/5 * t
                drones[MY_ID][1] = drones[MY_ID][1]+(self.mu[MY_ID][1] - drones[MY_ID][1])/5 * t
...
def getOtherAgentsPosition(position_client1, position_client2):
    ...
    clients = [position_client1, None, position_client2]
